...
const mockQueries = [
  {
    ...
    farmerId: 'F001',
    type: 'text',
    content: 'My tomato plants are showing yellow leaves with brown spots. What should I do?',
    category: 'disease',
    status: 'answered',
    createdAt: '2024-01-15T10:30:00Z',
    answeredAt: '2024-01-15T11:45:00Z',
    officerResponse: 'This appears to be early blight disease. Apply copper-based fungicide and improve air circulation.'
  }
];
...
const mockAlerts = [
  {
    ...
    description: 'Heavy to very heavy rainfall expected in next 48 hours. Farmers advised to harvest ready crops.',
  ...
  },
  {
    ...
    description: 'Increased BPH activity reported in rice fields. Regular monitoring recommended.',
...
export const handlers = [
  ...
  // Dashboard - Get Escalated Queries
  http.get('/api/dashboard/queries', ({ request }) => {
    ...
    let filteredQueries = escalatedQueries;
